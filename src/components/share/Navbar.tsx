          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4">
                <Link href={"/register"}>
                  <button className={`border-2 px-5 py-2 rounded-full hover:bg-white hover:text-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl ${
                      isScrolled ? "border-red-500 text-black" : "border-white text-white"
                  }`}>
                    Sign Up
                  </button>
                </Link>

...
// const ChatWindow = ({ messages: propMessages, activeUser, currentUserId }: ChatWindowProps) => {
//   // --- DESIGN CONSTANTS ---
...
//   }, [propMessages, activeUser.id]);

//   // Auto-scroll logic remains intact
//   useEffect(() => {
...
//   return (
//     // Re-applied the overall design classes from the previous version
...
//           <img src={activeUser.image} alt={activeUser.name} className="h-10 w-10 rounded-full object-cover" />
//           <div>
...
//           </div>
//         </div>
//         <Button variant="ghost" className="rounded-md h-8 w-8 p-0 text-gray-400 hover:bg-gray-200">
...
//         {/* DESIGN ELEMENT: Today divider (Added back) */}
//         <div className="flex justify-center text-xs text-gray-400">
//           Today, 10:30 AM
//         </div>

//         {messages.map((msg, i) => (
//           <div key={i} className={`flex items-end ${msg.sender === "me" ? "justify-end" : "justify-start"}`}>
//             {msg.sender === "them" && (
//               <img
...
//         {/* DESIGN ELEMENT: End of conversation notice (Moved up before the ref) */}
//         <div className="flex justify-center text-xs text-gray-400 pt-2">
//           End of conversation
//         </div>

//         {/* LOGIC ELEMENT: Ref for auto-scroll (MUST be the last child) */}
